...
<div class="popup-body">
    <h2 class="popup-title">{{$lang['buy']}} . {{ strtoupper(token_symbol()) }} . {{$lang['tokens']}}</h2>
    <div class="tranx-payment-details">
        <form action="{{ route('user.ajax.token.access') }}" method="POST" id="token_payment">
            ...
            <button type="submit" class="btn  btn-alt btn-primary payment-btn">{{$lang['proceed']}}<em class="ti-arrow-right"></em></button>   
