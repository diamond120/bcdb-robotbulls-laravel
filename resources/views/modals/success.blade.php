<div class="popup-body">
    ...
    <div class="popup-content">
        <form action="{{ route('payment.bank.update') }}" method="POST" id="payment-confirm" class="validate-modern" autocomplete="off">
            ...
            $transaction = Transaction::where('id', $trnx_id)->first();
            ...
            <p>{!! __($lang['please_send_amount_to_address_below'], ['amount' => '<strong class="text-primary">'.$transaction->amount.'</strong>', 'currency' => '<strong class="text-primary">'.$_CUR.'</strong>'])  !!} {!! __($lang['the_funds_will_appear_in_your_account_after_confirmations'], [ 'num' => '<strong>3</strong>', 'gateway' => '<strong>'.$_gateway.'</strong>' ]) !!}</p>
...
<!--                        <div class="fake-class pl-sm-3">-->
                        <div class="fake-class">
                            ...
                            <div class="copy-wrap mgb-0-5x">
                                ...
                                <input type="text" class="copy-address" value="{{ $wallet_address }}" disabled="">
                                <button type="button" class="copy-trigger copy-clipboard" data-clipboard-text="{{ $wallet_address }}"><em class="ti ti-files"></em></button>
                            </div>
