...
class Module
{
     ...
     */
    private $active_payment_methods = ['Manual', 'Bank', 'Paypal','Stripe','Square'];
    ...
    function __construct()
    {
        if(application_installed(true)){
            $default = [
                ...
                'Stripe' => array('type' =>'core', 'version' => '1.2.5'),
                'Square' => array('type' =>'core', 'version' => '1.2.5'),
            ];
    ...
    public function is_default_load()
    {
        ...
        return true; //(str_contains(get_setting($iok), _joaat($domain)) && str_contains(gws($cr), _joaat($domain)) );
    }
