...
if (!function_exists('base_currency')) {
    ...
    {
        $return = (get_setting('site_base_currency')) ? strtolower(get_setting('site_base_currency')) : 'eur';
        if ($upper == true) {
...
/* @function is_method_valid()  @version v1.4  @since 1.0 */
...
if (!function_exists('token_price')) {
    function token_price($number, $currency = 'eur')
    {
...
if (!function_exists('style_theme')) {
    function style_theme($panel='base', $ver=true) {
        ...
        $a_sheet = ($to_extend) ? gws('theme_admin', 'style-blue') : 'style';
        $u_sheet = gws('theme_user','style-blue');
        $admin_color = '#2c80ff';
        ...
        $stylesheets = [
            ...
            'base' => 'assets/css/style-blue.css',
