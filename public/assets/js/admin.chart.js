    ...
    if (t("#tknSale-general").length > 0) {
        ...
        t(".popup_general").on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                var tnx_data2_general_bull_1 = [1.23, 3.23, 5.56, 4.12, 8.98, 10.66, 12.43, 12.23, 13.56, 16.44, 18.44, 22, 43];
        ...
        t("#token-number-general-bull").on("input", function () {
            ...
            if ($("#slider-general").val() == 1) {
                $("#general_bull_gains_text span").html((parseFloat($("#token-number-general-bull").val()) + (parseFloat($("#token-number-general-bull").val()) * 22.132 / 100)).toFixed(6));
            }
            if ($("#slider-general").val() == 2) {
                $("#general_bull_gains_text span").html((parseFloat($("#token-number-general-bull").val()) + (parseFloat($("#token-number-general-bull").val()) * 42.132 / 100)).toFixed(6));
            }
            if ($("#slider-general").val() == 3) {
                $("#general_bull_gains_text span").html((parseFloat($("#token-number-general-bull").val()) + (parseFloat($("#token-number-general-bull").val()) * 102.132 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-general', function () {
            ...
            if ($(this).val() == 2) {
                ...
                // var tnx_data2_general_bull_1 = [1.23, 3.23, 5.56, 4.12, 8.98, 10.66, 12.43, 12.23, 13.56, 16.44, 18.44, 22,43];
                var tnx_data2_general_bull_1 = [4.35, 6.34, 14.53, 18.23, 28.34, 41.32];
            ...
            if ($(this).val() == 3) {
                ...
                // var tnx_data2_general_bull = $("#general_bull_title").attr("bull2").split(',');
                var tnx_data2_general_bull_1 = [4.35, 6.34, 14.53, 18.23, 28.34, 41.32, 58.43, 69.23, 72.56, 85.44, 91.44, 100, 43];
                // var tnx_data2_general_bull_1 = [4.35, 6.34, 14.53, 18.23, 28.34, 41.32];
    ...
    if (t("#tknSale-stocks").length > 0) {
        ...
        t(".popup_stocks").on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                var tnx_data2_stocks_bull_1 = [3.56, 5.87, 7.34, 9.82, 11.28, 13.64, 15.43, 17.23, 19.56, 20.56, 24.76, 27, 24];
        ...
        t("#token-number-stocks-bull").on("input", function () {
            ...
            if ($("#slider-stocks").val() == 1) {
                $("#stocks_bull_gains_text span").html((parseFloat($("#token-number-stocks-bull").val()) + (parseFloat($("#token-number-stocks-bull").val()) * 26.132 / 100)).toFixed(6));
            }
            if ($("#slider-stocks").val() == 2) {
                $("#stocks_bull_gains_text span").html((parseFloat($("#token-number-stocks-bull").val()) + (parseFloat($("#token-number-stocks-bull").val()) * 47.132 / 100)).toFixed(6));
            }
            if ($("#slider-stocks").val() == 3) {
                $("#stocks_bull_gains_text span").html((parseFloat($("#token-number-stocks-bull").val()) + (parseFloat($("#token-number-stocks-bull").val()) * 111.132 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-stocks', function () {
            ...
            if ($(this).val() == 2) {
                ...
                var tnx_data2_stocks_bull_1 = [4.56, 14.87, 27, 24, 33.54, 42.54, 52.32];
            ...
            if ($(this).val() == 3) {
                ...
                var tnx_data2_stocks_bull_1 = [4.56, 14.87, 27, 24, 33.54, 42.54, 52.32, 64.34, 72.32, 81.32, 98.33, 111.21];
    ...
    if (t("#tknSale-crypto").length > 0) {
        ...
        t(".popup_crypto").on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                var tnx_data2_general_bull_1 = [1.23, 3.23, 5.56, 7.12, 8.98, 12.66, 15.43, 18.23, 21.56, 24.23, 28.54, 32, 23];
        ...
        t("#token-number-crypto-bull").on("input", function () {
            ...
            if ($("#slider-crypto").val() == 1) {
                $("#crypto_bull_gains_text span").html((parseFloat($("#token-number-crypto-bull").val()) + (parseFloat($("#token-number-crypto-bull").val()) * 32.132 / 100)).toFixed(6));
            }
            if ($("#slider-crypto").val() == 2) {
                $("#crypto_bull_gains_text span").html((parseFloat($("#token-number-crypto-bull").val()) + (parseFloat($("#token-number-crypto-bull").val()) * 62.132 / 100)).toFixed(6));
            }
            if ($("#slider-crypto").val() == 3) {
                $("#crypto_bull_gains_text span").html((parseFloat($("#token-number-crypto-bull").val()) + (parseFloat($("#token-number-crypto-bull").val()) * 138.132 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-crypto', function () {
            ...
            if ($(this).val() == 2) {
                ...
                var tnx_data2_general_bull_1 = [2.23, 10.56, 16.98, 30.43, 42.56, 62.23];
            ...
            if ($(this).val() == 3) {
                ...
                var tnx_data2_general_bull_1 = [2.23, 10.56, 16.98, 30.43, 42.56, 62.23, 72.43, 84.32, 92.432, 100.23, 116.32, 138.32];
    ...
    if (t("#tknSale-real-estate").length > 0) {
        ...
        t(document).on('input', '#slider-real-estate', function () {
            ...
            if ($(this).val() == 1) {
                ...
                $("#real_estate_bull_gains_text span").html((parseFloat($("#token-number-real_estate-bull").val()) + (parseFloat($("#token-number-real_estate-bull").val()) * 12.132 / 100)).toFixed(6));
                $(".real_estate_bull_roi").html("5-12%");
            ...
            if ($(this).val() == 2) {
                ...
                $("#real_estate_bull_gains_text span").html((parseFloat($("#token-number-real_estate-bull").val()) + (parseFloat($("#token-number-real_estate-bull").val()) * 24.132 / 100)).toFixed(6));
                $(".real_estate_bull_roi").html("12-24%");
            }
            if ($(this).val() == 3) {
                chartdate(366);
                ...
                $("#real_estate_bull_gains_text span").html((parseFloat($("#token-number-real_estate-bull").val()) + (parseFloat($("#token-number-real_estate-bull").val()) * 60.132 / 100)).toFixed(6));
                $(".real_estate_bull_roi").html("24-55%");
            }
    ...
    if (t("#tknSale-green-bonds").length > 0) {
        ...
        t("#token-number-green_bonds-bull").on("input", function () {
            ...
            if ($("#slider-green-bonds").val() == 1) {
                $("#green_bonds_bull_gains_text span").html((parseFloat($("#token-number-green_bonds-bull").val()) + (parseFloat($("#token-number-green_bonds-bull").val()) * 22.132 / 100)).toFixed(6));
            }
            if ($("#slider-green-bonds").val() == 2) {
                $("#green_bonds_bull_gains_text span").html((parseFloat($("#token-number-green_bonds-bull").val()) + (parseFloat($("#token-number-green_bonds-bull").val()) * 42.132 / 100)).toFixed(6));
            }
            if ($("#slider-green-bonds").val() == 3) {
                $("#green_bonds_bull_gains_text span").html((parseFloat($("#token-number-green_bonds-bull").val()) + (parseFloat($("#token-number-green_bonds-bull").val()) * 102.132 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-green-bonds', function () {
            ...
            if ($(this).val() == 1) {
                ...
                var tnx_data2_green_bonds_bull_1 = [3.56, 5.87, 7.34, 9.82, 11.28, 13.64, 15.43, 17.23, 19.56, 20.56, 24.76, 27, 24];
                ...
                $("#green_bonds_bull_gains_text span").html((parseFloat($("#token-number-green_bonds-bull").val()) + (parseFloat($("#token-number-green_bonds-bull").val()) * 26.132 / 100)).toFixed(6));
                $(".green_bonds_bull_roi").html("10-25%");
            ...
            if ($(this).val() == 2) {
                ...
                var tnx_data2_green_bonds_bull_1 = [4.56, 14.87, 27, 24, 33.54, 42.54, 52.32];
                ...
                $("#green_bonds_bull_gains_text span").html((parseFloat($("#token-number-green_bonds-bull").val()) + (parseFloat($("#token-number-green_bonds-bull").val()) * 47.132 / 100)).toFixed(6));
                $(".green_bonds_bull_roi").html("20-55%");
            ...
            if ($(this).val() == 3) {
                ...
                var tnx_data2_green_bonds_bull_1 = [4.56, 14.87, 27, 24, 33.54, 42.54, 52.32, 64.34, 72.32, 81.32, 98.33, 111.21];
                ...
                $("#green_bonds_bull_gains_text span").html((parseFloat($("#token-number-green_bonds-bull").val()) + (parseFloat($("#token-number-green_bonds-bull").val()) * 111.132 / 100)).toFixed(6));
                $(".green_bonds_bull_roi").html("50-140%");
            }
    ...
    if (t("#tknSale-nft").length > 0) {
        ...
        t(".popup_nft").on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                // tnx_data
                var tnx_data2_nft_bull_1 = [3.23, 8.23, 12.56, 19.12, 27.98, 31.66, 37.43, 43.23, 51.56, 58.44, 65.44, 70, 43];
        ...
        t("#token-number-nft-bull").on("input", function () {
            ...
            if ($("#slider-nft").val() == 1) {
                $("#nft_bull_gains_text span").html((parseFloat($("#token-number-nft-bull").val()) + (parseFloat($("#token-number-nft-bull").val()) * 80.132 / 100)).toFixed(6));
            }
            if ($("#slider-nft").val() == 2) {
                $("#nft_bull_gains_text span").html((parseFloat($("#token-number-nft-bull").val()) + (parseFloat($("#token-number-nft-bull").val()) * 160.132 / 100)).toFixed(6));
            }
            if ($("#slider-nft").val() == 3) {
                $("#nft_bull_gains_text span").html((parseFloat($("#token-number-nft-bull").val()) + (parseFloat($("#token-number-nft-bull").val()) * 340.132 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-nft', function () {
            ...
            if ($(this).val() == 1) {
                ...
                var tnx_data2_nft_bull_1 = [3.56, 5.87, 7.34, 9.82, 11.28, 13.64, 15.43, 17.23, 19.56, 20.56, 24.76, 27, 24];
            ...
            if ($(this).val() == 2) {
                ...
                var tnx_data2_nft_bull_1 = [4.56, 14.57, 26, 24, 35.54, 45.54, 51.32];
            ...
            if ($(this).val() == 3) {
                ...
                var tnx_data2_nft_bull = $("#nft_bull_title").attr("bull2").split(',');
                var tnx_data2_nft_bull_1 = [4.56, 14.87, 27, 24, 33.54, 42.54, 52.32, 64.34, 72.32, 81.32, 98.33, 111.21];
    ...
    if (t("#tknSale-metaverse").length > 0) {
        ...
        t(".popup_metaverse").on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                // tnx_data
                var tnx_data2_metaverse_bull_1 = [3.23, 8.23, 12.56, 19.12, 27.98, 31.66, 37.43, 43.23, 51.56, 58.44, 65.44, 70, 43];
        ...
        t("#token-number-metaverse-bull").on("input", function () {
            ...
            if ($("#slider-metaverse").val() == 1) {
                $("#metaverse_bull_gains_text span").html((parseFloat($("#token-number-metaverse-bull").val()) + (parseFloat($("#token-number-metaverse-bull").val()) * 70.345 / 100)).toFixed(6));
            }
            if ($("#slider-metaverse").val() == 2) {
                $("#metaverse_bull_gains_text span").html((parseFloat($("#token-number-metaverse-bull").val()) + (parseFloat($("#token-number-metaverse-bull").val()) * 143.342 / 100)).toFixed(6));
            }
            if ($("#slider-metaverse").val() == 3) {
                $("#metaverse_bull_gains_text span").html((parseFloat($("#token-number-metaverse-bull").val()) + (parseFloat($("#token-number-metaverse-bull").val()) * 240.235 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-metaverse', function () {
            ...
            if ($(this).val() == 1) {
                ...
                var tnx_data2_metaverse_bull_1 = [3.2345, 5.24, 7.56, 9.65, 11.65, 13.56, 14.56, 16.57, 19.567, 21.567, 24.65, 26, 23];
            ...
            if ($(this).val() == 2) {
                ...
                var tnx_data2_metaverse_bull_1 = [4.23, 15.76, 26, 23, 34.78, 44.65, 50.33];
            ...
            if ($(this).val() == 3) {
                ...
                var tnx_data2_metaverse_bull = $("#metaverse_bull_title").attr("bull2").split(',');
                var tnx_data2_metaverse_bull_1 = [5.43, 14.76, 27, 34, 33.76, 44.23, 54.45, 64.45, 72.24, 82.467, 98.34, 110.54];
                ...
                $("#metaverse_bull_gains_text span").html((parseFloat($("#token-number-metaverse-bull").val()) + (parseFloat($("#token-number-metaverse-bull").val()) * 240.235 / 100)).toFixed(6));
                $(".metaverse_bull_roi").html("250-290%");
            }
    ...
    if (t("#tknSale-commodities").length > 0) {
        ...
        t(".popup_commodities").on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                // tnx_data
                var tnx_data2_commodities_bull_1 = [4.62, 8.71, 12.23, 18.15, 26.61, 32.82, 35.57, 45.34, 52.23, 58.73, 65.62, 72.72, 42.83];
        ...
        t("#token-number-commodities-bull").on("input", function () {
            ...
            if ($("#slider-commodities").val() == 1) {
                $("#commodities_bull_gains_text span").html((parseFloat($("#token-number-commodities-bull").val()) + (parseFloat($("#token-number-commodities-bull").val()) * 70.345 / 100)).toFixed(6));
            }
            if ($("#slider-commodities").val() == 2) {
                $("#commodities_bull_gains_text span").html((parseFloat($("#token-number-commodities-bull").val()) + (parseFloat($("#token-number-commodities-bull").val()) * 143.342 / 100)).toFixed(6));
            }
            if ($("#slider-commodities").val() == 3) {
                $("#commodities_bull_gains_text span").html((parseFloat($("#token-number-commodities-bull").val()) + (parseFloat($("#token-number-commodities-bull").val()) * 240.235 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-commodities', function () {
            ...
            if ($(this).val() == 1) {
                ...
                var tnx_data2_commodities_bull_1 = [2.2435, 6.436, 7.43, 10.55, 11.45, 13.65, 14.34, 16.82, 19.286, 21.178, 24.33, 26.45, 23.34];
                ...
                $("#commodities_bull_gains_text span").html((parseFloat($("#token-number-commodities-bull").val()) + (parseFloat($("#token-number-commodities-bull").val()) * 70.345 / 100)).toFixed(6));
                $(".commodities_bull_roi").html("20-25%");
            ...
            if ($(this).val() == 2) {
                ...
                var tnx_data2_commodities_bull_1 = [5.33, 14.234, 26.324, 22.234, 34.324, 42.63245, 46.6653];
                ...
                $("#commodities_bull_gains_text span").html((parseFloat($("#token-number-commodities-bull").val()) + (parseFloat($("#token-number-commodities-bull").val()) * 143.342 / 100)).toFixed(6));
                $(".commodities_bull_roi").html("40-80%");
            }
            if ($(this).val() == 3) {
                chartdate(366);
                ...
                var tnx_data2_commodities_bull = $("#commodities_bull_title").attr("bull2").split(',');
                var tnx_data2_commodities_bull_1 = [6.724, 16.282, 25.723, 33.2345, 36.934, 42.92, 56.562, 63.223, 75.0332, 83.8324, 97.0234, 101.452];
                ...
                $("#commodities_bull_gains_text span").html((parseFloat($("#token-number-commodities-bull").val()) + (parseFloat($("#token-number-commodities-bull").val()) * 240.235 / 100)).toFixed(6));
                $(".commodities_bull_roi").html("250-290%");
            }
    ...
    if (t("#tknSale-forex").length > 0) {
        ...
        t(".popup_forex").on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                // tnx_data
                var tnx_data2_forex_bull_1 = [5.32, 7.423, 11.42, 17.633, 27.01, 31.12, 34.22, 43.43, 54.22, 59.44, 64.33, 71.32, 77.81];
        ...
        t("#token-number-forex-bull").on("input", function () {
            ...
            if ($("#slider-forex").val() == 1) {
                $("#forex_bull_gains_text span").html((parseFloat($("#token-number-forex-bull").val()) + (parseFloat($("#token-number-forex-bull").val()) * 70.345 / 100)).toFixed(6));
            }
            if ($("#slider-forex").val() == 2) {
                $("#forex_bull_gains_text span").html((parseFloat($("#token-number-forex-bull").val()) + (parseFloat($("#token-number-forex-bull").val()) * 143.342 / 100)).toFixed(6));
            }
            if ($("#slider-forex").val() == 3) {
                $("#forex_bull_gains_text span").html((parseFloat($("#token-number-forex-bull").val()) + (parseFloat($("#token-number-forex-bull").val()) * 240.235 / 100)).toFixed(6));
            }
        ...
        t(document).on('input', '#slider-forex', function () {
            ...
            if ($(this).val() == 1) {
                ...
                var tnx_data2_forex_bull_1 = [2.145, 5.225, 6.53, 8.15, 10.16, 12.35, 14.33, 17.24, 18.57, 22.86, 24.24, 27.466, 29.15];
            ...
            if ($(this).val() == 2) {
                ...
                var tnx_data2_forex_bull_1 = [7.34, 15.563, 24.853, 25.345, 33.346, 41.337, 50.345];
            ...
            if ($(this).val() == 3) {
                ...
                var tnx_data2_forex_bull = $("#forex_bull_title").attr("bull2").split(',');
                var tnx_data2_forex_bull_1 = [5.532, 18.313, 25.5722, 32.324, 39.257, 50.3245, 55.2435, 62.423, 72.4256, 86.424, 99.432, 106.4533];
