        ...
        $global = [
            ///// MESSAGES /////
              ...
              "messages.verify.success.msg" => [
                "text" => "Please sign-in to start trading.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
            ...
            ///// USER BUY TOKEN /////
              ...
              "buy_token.choose_method" => [
                "text" => "You can choose any of following payment method to make your payment. The account balance will appear in your account after successful payment.", // v1.1.4
                "pages" => "buy_token",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// ORDER PROCEDD /////
              ...
              "payment.info.crypto_receive" => [
                "text" => "Please send :amount :currency to the address below. The balance will appear in your account only after transaction gets :num confirmation and approved by our team.",
                "pages" => "payment, order",
                "panel" => "user",
                "load" => 0
              ],
              "payment.info.bank_amount" => [
                "text" => "Please make your payment of :amount :currency through bank to the below bank address. The balance will appear in your account only after your transaction gets approved by our team.",
                "pages" => "payment, order",
                "panel" => "user",
                "load" => 0
              ],
              "payment.info.bank_receive" => [
                "text" => "Please make your payment of :amount :currency through bank to the below bank address. The will appear in your account only after your transaction gets approved by our team.",
                "pages" => "payment, order",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "payment.info.gateway_receive" => [
                "text" => "Please make your payment of :amount :currency through :gateway. The balance will appear in your account after we received your payment.",
                "pages" => "payment, order",
                "panel" => "user",
                "load" => 0
              ],
...
//                "text" => "Please make payment of :amount to receive :token_amount token including bonus :token_bonus token.",
                "text" => "Please enter an amount between $500 and $2000 for the 3 month plan.",
...
//                "text" => "Please make payment of :amount to receive :token_amount token.",
              ...
              "payment.agree_terms" => [
                "text" => "I hereby agree to the <a href='/privacy-policy/'>privacy policy</a> and to .",
                "pages" => "payment, manual",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// PAYMENT BANK TRANSFER /////
              ...
              "payment.bank_referance" => [
                "text" => "Use this transaction id (#:orderid) as reference. Make your payment within 78 hours, If we will not received your payment within 78 hours, then we will cancel the transaction.",
                "pages" => "payment, bank",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// AUTH 2FA /////
              ...
              "auth.2fa.enabled" => [
                "text" => "You successfully enabled 2FA in your account.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
