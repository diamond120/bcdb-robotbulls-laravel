...
class DemoData extends IcoHandler
{
    ...
    public static function default_pages($get = null)
    {
        $data = [
            'home_top' => [
                'title' => 'Thank you for your interest in our Artificial Intelligence investment Robot',
                'slug' => 'home_top',
                'custom_slug' => 'home-top-block',
                'menu_title' => 'Welcome block',
                'description' => "We are committed to improve your investment portfolio. Thanks to our AI Technology we are capable of predicting financial markets within specific time frames. Our Investment Robot will place your money in the safest and most reliable assets for you. 
                Currently, we offer three plans: a 3-month period with 60% accuracy, a 6-month period with 70% accuracy, and a 1-year period with 80% accuracy. Regardless of your budget, we have <strong> the best strategy for you!</strong>",
                'status' => 'active',
                'lang' => 'en',
                'public' => 0,
            ],
