    ...
    if (t("#tknSale-"+bulls[h][0]).length > 0) {
        ...
        t(".popup_"+bulls[h][0]).on("click", function (e) {
            ...
            t.get(r).done(t => {
                ...
                //set new labels
                tnx_labels = $("#"+bulls[h][0]+"_bull_title").attr("dates").split(',');
                
                //open asset data
                var asset_data = $("#"+bulls[h][0]+"_bull_title").attr("data").split(',');
...
//                var tnx_data2_general_bull_1 = $("#"+bulls[h][0]+"_bull_title").attr("bull").split(',');
                var bull_data = $("#"+bulls[h][0]+"_bull_title").attr("bull").split(',');
                var bull_data_new = [];
        ...
        t("#token-number-"+bulls[h][0]+"-bull").on("input", function () {
            ...
            if ($("#slider-"+bulls[h][0]).val() == 1) {
                $("#"+bulls[h][0]+"_bull_gains_text span").html((parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) + (parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) * $("#"+bulls[h][0]+"_bull_title").attr("bull").split(',')[11] / 100)).toFixed(2));
            }
            if ($("#slider-"+bulls[h][0]).val() == 2) {
                $("#"+bulls[h][0]+"_bull_gains_text span").html((parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) + (parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) * $("#"+bulls[h][0]+"_bull_title").attr("bull2").split(',')[5] / 100)).toFixed(2));
            }
            if ($("#slider-"+bulls[h][0]).val() == 3) {
                $("#"+bulls[h][0]+"_bull_gains_text span").html((parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) + (parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) * $("#"+bulls[h][0]+"_bull_title").attr("bull2").split(',')[11] / 100)).toFixed(2));
            }
        ...
        t(document).on('input', '#slider-'+bulls[h][0], function () {
            ...
            if ($(this).val() == 1) {
                ...
                $("#"+bulls[h][0]+"_bull_gains_text span").html((parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) + (parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) * $("#"+bulls[h][0]+"_bull_title").attr("bull").split(',')[11] / 100)).toFixed(2));
                $("."+bulls[h][0]+"_bull_roi").html(Math.round($("#"+bulls[h][0]+"_bull_title").attr("bull").split(',')[11])+"%");
            }
            if ($(this).val() == 2) {

//                chartdate2(180);
                //set new labels
                tnx_labels = $("#"+bulls[h][0]+"_bull_title").attr("dates2").split(',');
                tnx_labels.shift();
                tnx_labels.shift();
                tnx_labels.shift();
                tnx_labels.shift();
                ...
                //open asset data
                var asset_data = $("#"+bulls[h][0]+"_bull_title").attr("data2").split(',');
                asset_data.shift();
                asset_data.shift();
                asset_data.shift();
                asset_data.shift();
                ...
                //Bull data
                var bull_data = $("#"+bulls[h][0]+"_bull_title").attr("bull2").split(',');
                var bull_data_new = [];
                bull_data_new[0] = asset_data_rounded[0];
                ...
                $("#"+bulls[h][0]+"_bull_gains_text span").html((parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) + (parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) * $("#"+bulls[h][0]+"_bull_title").attr("bull2").split(',')[5] / 100)).toFixed(2));
                $("."+bulls[h][0]+"_bull_roi").html(Math.round($("#"+bulls[h][0]+"_bull_title").attr("bull2").split(',')[5])+"%");
...
//                chartdate(366);
                ...
                $("#"+bulls[h][0]+"_bull_gains_text span").html((parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) + (parseFloat($("#token-number-"+bulls[h][0]+"-bull").val()) * $("#"+bulls[h][0]+"_bull_title").attr("bull2").split(',')[11] / 100)).toFixed(2));
                $("."+bulls[h][0]+"_bull_roi").html(Math.round($("#"+bulls[h][0]+"_bull_title").attr("bull2").split(',')[11])+"%");
