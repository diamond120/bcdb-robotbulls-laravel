...
const A = class {
        ...
        componentDidLoad() {
            z((async () => {
                ...
                d.getBoolean("_testing") || __sc_import_ionic("./p-af8d8301.js").then((t => t.startTapClick(d))), d.getBoolean("statusTap", t) && __sc_import_ionic("./p-5cb41a30.js").then((t => t.startStatusTap())), d.getBoolean("inputShims", y()) && __sc_import_ionic("./p-7f4eed0e.js").then((t => t.startInputShims(d)));
                const o = await __sc_import_ionic("./p-0b7fe16d.js");
                d.getBoolean("hardwareBackButton", t) ? o.startHardwareBackButton() : o.blockHardwareBackButton(), "undefined" != typeof window && __sc_import_ionic("./p-20a74982.js").then((t => t.startKeyboardAssist(window))), __sc_import_ionic("./p-5abed003.js").then((t => this.focusVisible = t.startFocusVisible()))
            }))
        }
        async setFocus(t) {
    ...
    y = () => c(window, "ios") && c(window, "mobile"),
    z = t => {
        "requestIdleCallback" in window ? window.requestIdleCallback(t) : setTimeout(t, 32)
    };
A.style = "html.plt-mobile ion-app{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}html.plt-mobile ion-app [contenteditable]{-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text}ion-app.force-statusbar-padding{--ion-safe-area-top:20px}";
const j = class {
    constructor(o) {
...
const M = class {
        ...
        resize() {
            this.fullscreen ? r((() => this.readDimensions())) : 0 === this.cTop && 0 === this.cBottom || (this.cTop = this.cBottom = 0, a(this))
        }
        readDimensions() {
            const t = Z(this.el),
                o = Math.max(this.el.offsetTop, 0),
                i = Math.max(t.offsetHeight - o - this.el.offsetHeight, 0);
            (o !== this.cTop || i !== this.cBottom) && (this.cTop = o, this.cBottom = i, a(this))
        }
        onScroll(t) {
            const o = Date.now(),
                i = !this.isScrolling;
            this.lastScroll = o, i && this.onScrollStart(), !this.queued && this.scrollEvents && (this.queued = !0, r((o => {
                this.queued = !1, this.detail.event = t, C(this.detail, this.scrollEl, o, i), this.ionScroll.emit(this.detail)
            })))
        }
        async getScrollElement() {
            return this.scrollEl || await new Promise((t => p(this.el, t))), Promise.resolve(this.scrollEl)
        }
        scrollToTop(t = 0) {
        ...
        async scrollToBottom(t = 0) {
            ...
            return this.scrollToPoint(void 0, o.scrollHeight - o.clientHeight, t)
        }
        async scrollByPoint(t, o, i) {
            const n = await this.getScrollElement();
            return this.scrollToPoint(t + n.scrollLeft, o + n.scrollTop, i)
        }
        async scrollToPoint(t, o, i = 0) {
            const n = await this.getScrollElement();
            if (i < 32) return null != o && (n.scrollTop = o), void(null != t && (n.scrollLeft = t));
            let e, r = 0;
            const a = new Promise((t => e = t)),
                s = n.scrollTop,
                l = n.scrollLeft,
                d = null != o ? o - s : 0,
                c = null != t ? t - l : 0,
                p = t => {
                    const o = Math.min(1, (t - r) / i) - 1,
                        a = Math.pow(o, 3) + 1;
                    0 !== d && (n.scrollTop = Math.floor(a * d + s)), 0 !== c && (n.scrollLeft = Math.floor(a * c + l)), a < 1 ? requestAnimationFrame(p) : e()
                };
        ...
        render() {
            const {
                ...
                scrollY: e,
                el: r
            } = this, a = m(r) ? "rtl" : "ltr", s = l(this), d = this.shouldForceOverscroll(), c = "ios" === s, p = t ? "main" : "div";
            return this.resize(), o(i, {
                ...
                class: {
                    "inner-scroll": !0, "scroll-x": n, "scroll-y": e, overscroll: (n || e) && d
                },
    ...
    Z = t => {
        ...
        if (o) return o;
        return t.closest("ion-app, ion-page, .ion-page, page-inner, .popover-content") || (t => t.parentElement ? t.parentElement : t.parentNode && t.parentNode.host ? t.parentNode.host : null)(t)
    },
    C = (t, o, i, n) => {
        const e = t.currentX,
            r = t.currentY,
...
const I = t => {
    ...
    E = (t, o) => {
        "fade" !== t.collapse && (void 0 === o ? t.style.removeProperty("--opacity-scale") : t.style.setProperty("--opacity-scale", o.toString()))
    },
    U = (t, o = !0) => {
    ...
    R = (t, o, i) => {
        r((() => {
            const n = t.scrollTop,
                e = o.clientHeight,
                r = i ? i.clientHeight : 0;
            if (null !== i && n < r) return o.style.setProperty("--opacity-scale", "0"), void t.style.setProperty("clip-path", `inset(${e}px 0px 0px 0px)`);
            const a = b(0, (n - r) / 10, 1);
            s((() => {
                t.style.removeProperty("clip-path"), o.style.setProperty("--opacity-scale", a.toString())
            }))
        }))
    },
    G = class {
        constructor(o) {
            t(this, o), this.inheritedAttributes = {}, this.translucent = !1, this.setupFadeHeader = async (t, o) => {
                if (!t) return void console.error("ion-header requires a content to collapse. Make sure there is an ion-content.");
                await new Promise((o => p(t, o)));
                const i = this.scrollEl = await t.getScrollElement();
                this.contentScrollCallback = () => {
                    R(this.scrollEl, this.el, o)
                }, i.addEventListener("scroll", this.contentScrollCallback), R(this.scrollEl, this.el, o)
            }
        }
        componentWillLoad() {
            this.inheritedAttributes = h(this.el, ["role"])
        }
        componentDidLoad() {
        ...
        async setupCondenseHeader(t, o) {
            ...
            const n = D(this.collapsibleMainHeader),
                e = D(this.el);
            n && e && (U(n, !1), E(n.el, 0), this.intersectionObserver = new IntersectionObserver((t => {
                ((t, o, i, n) => {
                    s((() => {
                        const e = n.scrollTop;
                        ((t, o, i) => {
                            if (!t[0].isIntersecting) return;
                            const n = t[0].intersectionRatio > .9 || i <= 0 ? 0 : 100 * (1 - t[0].intersectionRatio) / 75;
                            E(o.el, 1 === n ? void 0 : n)
                        })(t, o, e);
                        const r = t[0],
                            a = r.intersectionRect,
                            s = a.width * a.height,
                            l = 0 === s && 0 == r.rootBounds.width * r.rootBounds.height,
                            d = Math.abs(a.left - r.boundingClientRect.left),
                            c = Math.abs(a.right - r.boundingClientRect.right);
                        l || s > 0 && (d >= 5 || c >= 5) || (r.isIntersecting ? (U(o, !1), U(i)) : (0 === a.x && 0 === a.y || 0 !== a.width && 0 !== a.height) && e > 0 && (U(o), U(i, !1), E(o.el)))
                    }))
                })(t, n, e, this.scrollEl)
            }), {
                root: t,
                ...
                ((t, o, i) => {
                    r((() => {
                        const n = b(1, 1 + -t.scrollTop / 500, 1.1);
                        null === i.querySelector("ion-refresher.refresher-native") && s((() => {
                            ((t = [], o = 1, i = !1) => {
                                t.forEach((t => {
                                    const n = t.ionTitleEl,
                                        e = t.innerTitleEl;
                                    n && "large" === n.size && (e.style.transition = i ? "all 0.2s ease-in-out" : "", e.style.transform = `scale3d(${o}, ${o}, 1)`)
                                }))
                            })(o.toolbars, n)
                        }))
                    }))
                })(this.scrollEl, e, t)
            }, this.scrollEl.addEventListener("scroll", this.contentScrollCallback), s((() => {
        ...
        render() {
            ...
            } = this, e = l(this), r = this.collapse || "none", a = f("ion-menu", this.el) ? "none" : "banner";
...
const T = class {
    constructor(o) {
        t(this, o), this.ionNavWillLoad = e(this, "ionNavWillLoad", 7), this.ionNavWillChange = e(this, "ionNavWillChange", 3), this.ionNavDidChange = e(this, "ionNavDidChange", 3), this.gestureOrAnimationInProgress = !1, this.mode = l(this), this.animated = !0
    }
    swipeHandlerChanged() {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await __sc_import_ionic("./p-6f9b08bc.js")).createSwipeBackGesture(this.el, (() => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart()), (() => t()), (t => this.ani && this.ani.progressStep(t)), ((t, o, i) => {
            if (this.ani) {
                this.ani.onFinish((() => {
                ...
                let n = t ? -.001 : .001;
                t ? n += x([0, 0], [.32, .72], [0, 1], [1, 1], o)[0] : (this.ani.easing("cubic-bezier(1, 0, 0.68, 0.28)"), n += x([0, 0], [1, 0], [.68, .28], [1, 1], o)[0]), this.ani.progressEnd(t ? 1 : 0, n, i)
    ...
    async setRoot(t, o, i) {
        if (this.activeComponent === t && g(o, this.activeParams)) return !1;
        const n = this.activeEl,
            e = await v(this.delegate, this.el, t, ["ion-page", "ion-page-invisible"], o);
        return this.activeComponent = t, this.activeEl = e, this.activeParams = o, await this.commit(e, n, i), await w(this.delegate, n), !0
    }
    async transition(t, o, i = {}) {
        ...
        const {
            el: n,
            mode: e
        } = this, r = this.animated && d.getBoolean("animated", !0), a = i.animationBuilder || this.animation || d.get("navAnimation");
        return await k(Object.assign(Object.assign({
            mode: e,
            animated: r,
            enteringEl: t,
            leavingEl: o,
            baseEl: n,
            progressCallback: i.progressAnimation ? t => {
...
T.style = ":host{left:0;right:0;top:0;bottom:0;position:absolute;contain:layout size style;overflow:hidden;z-index:0}";
const Y = class {
    constructor(o) {
    ...
    childrenStyle(t) {
        ...
        Object.keys(i).forEach((t => {
            const o = `toolbar-${t}`,
                a = i[t];
            a !== e[o] && (r = !0), a && (n[o] = !0)
        })), r && (this.childrenStyles.set(o, n), a(this))
    }
    render() {
        const t = l(this),
            n = {};
        return this.childrenStyles.forEach((t => {
            ...
            class: Object.assign(Object.assign({}, n), u(this.color, {
                [t]: !0,
...
export {
    A as ion_app, j as ion_buttons, M as ion_content, S as ion_footer, G as ion_header, T as ion_router_outlet, Y as ion_title, _ as ion_toolbar
}
