...
<head>
    ...
    @stack('header')
    <style>
        .reinvest-button {position: relative;text-align: left;padding: 6px 32px 6px 16px;white-space: nowrap;color: #495463;text-transform: uppercase;font-size: 12px;font-weight: 400;letter-spacing: 0.05em;display: flex;align-items: center;color: inherit;text-decoration: none;background-color: transparent;border:none;width: 100%;outline: 0;cursor: pointer} .reinvest-button:hover{color: #2c80ff;} .reinvest-button:focus {outline:0;}
            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        @if (auth()->user()->referral_rights == '1')
                        <li{!! ((is_page('referrals'))? ' class="active"' : '') !!}>
                            <a href="{{ route('admin.referrals', 'user') }}"><em class="ikon ikon-user-list"></em> Ambassadors</a>
                        </li>
                        @endif
                        ...
                        <li class="has-dropdown"><a class="drop-toggle" href="javascript:void(0)"><em class="ikon ikon-docs"></em> Management</a>
                            <ul class="navbar-dropdown">
                                ...
                                <li><a href="{{ route('admin.transactions', 'expiring') }}"> Expiring Trnx</a></li>
                                <li><a href="{{ route('admin.messages') }}"> Messages</a></li>
                                <li><a href="{{ route('admin.kycs', 'pending') }}"> KYC List</a></li>
                                <li><a href="{{ route('admin.users.wallet.change') }}"> Wallet Change</a></li>
                                <li><a href="{{ route('admin.referrals')  }}">Ambassadors</a></li>
                            </ul>
                        </li>
                        @endif
                        ...
                        <li class="has-dropdown"><a class="drop-toggle" href="javascript:void(0)"><em class="ikon ikon-user-list"></em> Search</a>
                            <ul class="navbar-dropdown">
                                ...
                                <li><a href="{{ route('admin.wallets') }}"> Wallets</a></li>
                            </ul>
                        </li>
                        @endif
...
-->
                        ...
                        <li class="has-dropdown"><a class="drop-toggle" href="javascript:void(0)"><em class="ikon ikon-settings"></em> Settings</a>
                            <ul class="navbar-dropdown">
                                <li><a href="{{ route('admin.stages') }}">ICO/STO Stage</a></li>
