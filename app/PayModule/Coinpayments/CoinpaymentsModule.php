...
class CoinpaymentsModule implements PmInterface
{
    ...
    {
        $test="test";
        error_log( "test2 2 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 3 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 4 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 5 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 6 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    public function email_details($transaction){
        $test="test";
        error_log( "test2 7 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 8 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 9 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 10 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
    ...
    {
        $test="test";
        error_log( "test2 11 " . json_encode($test) . "\n", 3, "/home/robotbq/app_rb_folder/storage/logs/php.log");
