<?php
	$lang = array(
        "lang" => "en",
        "sign_in" => "Sign in",
        "sign_in_with_your_account" => "with your RobotBulls Account",
        "phone" => "Phone",
        "your_phone" => "Your Phone",
        "email" => "Email",
        "continue" => "Continue",
        "required" => "Required",
        "phone_verification" => "SMS verification code",
        ...
        "sign_up" => "Connect",
        "create_robotbulls_account" => "Sign up/sign in to your RobotBulls Account",
