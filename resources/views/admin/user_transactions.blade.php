            ...
            <div class="popup-body popup-body-lg">
                ...
                <ul class="data-details-alt">
                    ...
                    <li class="text-dark row no-gutters justify-content-between">
                        ...
                        <div class="col-md col-sm-6"><span class="text-dark">{{ ucfirst($tnx->plan) }}</span></div>
                        <div class="col-md col-sm-6"><span class="text-dark">{{ ucfirst($tnx->duration) }}</span></div>
                        <div class="col-md col-sm-6"><span class="text-dark">{{ get_stage($tnx->stage, 'name') }}</span></div>
                        <div class="col-md col-sm-6"><span class="text-dark">{{ ($tnx->amount + $tnx->amount*121/365* (now()-strtotime($tnx->tnx_time)) /100) }}</span></div>
