...
<head>
    ...
    <meta name="google-signin-client_id" content="223289058332-2ja5mapdd6vrl6me566asvj12pnhiaec.apps.googleusercontent.com">
            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        <li><a href="{{ route('user.token') }}"><em class="ikon ikon-my-token"></em> {{ __('My Investments') }}</a></li>
                        @endif
